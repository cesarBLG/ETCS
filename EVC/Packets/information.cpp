...
void ces_information::handle()
{
    ...
    int result = handle_conditional_emergency_stop(emerg->NID_EM, *ref+emerg->D_EMERGENCYSTOP.get_value(emerg->Q_SCALE), d_minsafe(orig_position.est, confidence_data::from_distance(orig_position)));
