...
struct Level2_3_MA_Section
{
    ...
    Level2_3_MA_Section() = default;
    Level2_3_MA_Section(bit_read_temp &r)
    {
        r.read(&L_SECTION);
...
struct Level2_3_MA : ETCS_directional_packet
{
    Q_SCALE_t Q_SCALE;
    V_EMA_t V_EMA;
    T_EMA_t T_EMA;
    N_ITER_t N_ITER;
    std::vector<Level2_3_MA_Section> sections;
    ...
    Level2_3_MA *create(bit_read_temp &r) override
    {
        return new Level2_3_MA(r);
    }
};