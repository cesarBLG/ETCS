...
std::map<int,std::shared_ptr<Platform::Image>> object_textures;
void displayObjects()
{
...
/*std::shared_ptr<Platform::Image> plus_white;
std::shared_ptr<Platform::Image> plus_black;
std::shared_ptr<Platform::Image> minus_white;
std::shared_ptr<Platform::Image> minus_black;*/
...
std::shared_ptr<Platform::Image> pl21;
std::shared_ptr<Platform::Image> pl22;
std::shared_ptr<Platform::Image> pl23;
//std::map<int, std::shared_ptr<Platform::Image>> plspeeds;
void displaySpeed()
{
    if (pl21 == nullptr)
    {
